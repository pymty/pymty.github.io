...
BLOG_AUTHOR = "Python Monterrey"  # (translatable)
BLOG_TITLE = "Python Monterrey"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://www.pymty.org/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://www.pymty.org/"
BLOG_EMAIL = "hola@pymty.org"
BLOG_DESCRIPTION = "Grupo de usuarios de Python en Monterrey"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ("https://www.facebook.com/groups/pymty", "Facebook"),
        ("https://twitter.com/pymty", "Twitter"),
        ("https://pymty.slack.com/", "Slack"),
        ("https://github.com/pymty", "GitHub"),
        ("https://groups.google.com/forum/#!forum/pymty", "Google Group"),
        ("http://wiki.pymty.org/", "Wiki"),

    ),
    # "en": (
    #     ("/en/contacto.html", "Contact"),
    # ),
}
...
# This is meant to be a website, ignore the blog post parts
# POSTS = (
...
# )
# the pages are stored in the root of the output
PAGES = (
    ("pages/*.rst", "", "page.tmpl"),
    ("pages/*.md", "", "page.tmpl"),
    ("pages/*.txt", "", "page.tmpl"),
